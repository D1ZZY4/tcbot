...
| Tests | 1152 collected tests across 69 `tests/test_*.py` files; designed to run offline. All green on 2026-06-03. |
...
Result: 1152 tests collected across 69 test files.
