...
| Tests | 1251 collected tests across 71 `tests/test_*.py` files; designed to run offline. All green on 2026-06-03. |
...
Result: 1251 tests collected across 71 test files.
