...
| Tests | 1405 collected tests across 71 `tests/test_*.py` files; designed to run offline. All green on 2026-06-06. |
...
Result: 1405 tests collected across 71 test files.
