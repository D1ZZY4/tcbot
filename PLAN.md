...
| Tests | 1112 collected tests across 69 `tests/test_*.py` files; designed to run offline. All green on 2026-06-02. |
...
Result: 1112 tests collected across 69 test files.
