...
| Tests | 1337 collected tests across 70 `tests/test_*.py` files; designed to run offline. All green on 2026-06-03. |
...
Result: 1337 tests collected across 70 test files.
