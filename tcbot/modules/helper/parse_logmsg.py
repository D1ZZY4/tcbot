...
## ---------------------------------------------------------------------------
## Ban logs (posted to LOG_CHANNEL)
## ---------------------------------------------------------------------------
...
## ---------------------------------------------------------------------------
## Proof captions (posted to PROOF_TOPIC inside MAIN_GROUP)
## ---------------------------------------------------------------------------
...
def group_affiliation_rejected_log(
    chat_id: int,
    chat_title: str,
    owner_id: int,
    owner_fname: str,
