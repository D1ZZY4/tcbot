...
- Vision-capable model: `stepfun/step-3.7-flash:free` (StepFun Step 3.7 Flash) — native multimodal, supports both image and video input, used only for profile pictures / in-chat media, never for text-only calls.
