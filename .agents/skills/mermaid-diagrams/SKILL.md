...
Before invoking this skill, confirm the read/update rules in [`.agents/rules/CLAUDE.md`](../../rules/CLAUDE.md#mandatory-read-these-files-before-any-work). After adding or updating a diagram, update [`CHANGELOG.md`](../../../CHANGELOG.md) noting which doc gained the diagram, in the same turn.
