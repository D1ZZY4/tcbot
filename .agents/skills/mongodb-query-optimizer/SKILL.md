...
Before invoking this skill, confirm the read/update rules in [`.agents/rules/CLAUDE.md`](../../rules/CLAUDE.md#mandatory-read-these-files-before-any-work). After any change in `tcbot/database/`, update [`CHANGELOG.md`](../../../CHANGELOG.md), [`PLAN.md`](../../../PLAN.md) (if state changes), and [`docs/databases/databases.md`](../../../docs/databases/databases.md) in the same turn.
