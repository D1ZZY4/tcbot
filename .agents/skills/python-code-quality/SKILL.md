...
Before invoking this skill, confirm the read/update rules in [`.agents/rules/RULES.md`](../../rules/RULES.md#mandatory-read-before-work-and-update-after-work). After any code change, update [`CHANGELOG.md`](../../../CHANGELOG.md) and the matching `docs/*.md` in the same turn.
