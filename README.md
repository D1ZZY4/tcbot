...
The current collected inventory is 1112 tests across 69 `tests/test_*.py` files. The suite is designed to run offline without a real Telegram token or MongoDB connection.
...
- Test inventory: 1112 collected tests across 69 files.
