...
The current collected inventory is 1364 tests across 70 `tests/test_*.py` files. The suite is designed to run offline without a real Telegram token or MongoDB connection.
...
- Test inventory: 1364 collected tests across 70 files.
